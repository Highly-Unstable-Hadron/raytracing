...
impl Camera<'_> {
    ...
    pub fn construct<'a>(world: &'a World, width: i32, height: i32, camera: Point3, viewport_center: Point3, viewport_diagonal: Point3) -> Camera<'a> {
    ...
    pub fn ray_color(&self, ray: Ray) -> Color3 {
        ...
        let mut scattered_ray = ray.clone();
